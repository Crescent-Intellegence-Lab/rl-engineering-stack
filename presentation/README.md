...
- [`rl-engineering-tools-landscape.pptx`](rl-engineering-tools-landscape.pptx) — editable PowerPoint deck with speaker notes, generated by the build script or GitHub Actions.
...
A GitHub Actions workflow is included to rebuild and commit the PowerPoint whenever the presentation source changes. Organization-level Actions permissions may need to allow workflow execution and write access.
